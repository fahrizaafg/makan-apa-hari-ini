...
export const filterSpicy = document.getElementById('filter-spicy');
export const filterNoSpicy = document.getElementById('filter-no-spicy');
export const filterSoup = document.getElementById('filter-soup');
export const filterFried = document.getElementById('filter-fried');
export const filterHealthy = document.getElementById('filter-healthy');
export const filterRice = document.getElementById('filter-rice');
export const filterNoodle = document.getElementById('filter-noodle');
export const filterMeat = document.getElementById('filter-meat');
export const filterSeafood = document.getElementById('filter-seafood');
